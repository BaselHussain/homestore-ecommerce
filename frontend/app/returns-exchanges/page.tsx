        ...
        <section className="bg-primary text-primary-foreground py-10">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto text-center">
              {highlights.map((h, i) => (
                <AnimatedElement key={h.label} animationType="slideInUp" delay={i * 0.1}>
                  <div>
        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto relative">
              {steps.map((step, i) => (
                <AnimatedElement key={step.title} animationType="slideInUp" delay={i * 0.1}>
                  <div className="bg-card border border-border rounded-xl p-6 relative overflow-hidden hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 transition-all duration-300">
        ...
        <section className="py-20 md:py-28 bg-secondary">
          <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                <AnimatedElement key={faq.q} animationType="slideInUp" delay={i * 0.08}>
                  <div className="bg-card border border-border border-l-4 border-l-primary/40 rounded-xl p-6 hover:shadow-md hover:shadow-primary/10 hover:-translate-y-0.5 transition-all duration-300">
